...
## Features
SCREEN SHOOT OF THE HEADER
+The Header
	++

SCREEN SHOOT OF THE NAV
...
SCREEN SHOOT OF WORKS (The three galleries)
+The Works-section
	++ The Works-section displays three galleries of nine art pieces each displayed in a 3x3 grid
...
SCREEN SHOOT OF CONTACT (Adress and message-form)
+The Contact-section
...
The live link can be found here – Enebog Art - https://gustafenebog.github.io/CODE-project-1/index.html
